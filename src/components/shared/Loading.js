...
function Loading() {
  return (
    <>
      <div className="bg-[#262525] w-screen h-screen px-4 lg:px-12 py-12 md:flex md:justify-between ">
        <div className="flex md:w-[300px] xl:w-[400px]">
          <motion.img
        ...
        <div className=" flex items-end md:w-[400px] lg:w-[580px] xl:w-[700px]">
          <motion.img
